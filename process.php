...
if (isset($_POST['register'])) {
    ...
    $error = 0;
    if (!(preg_match("/^[a-zA-Z0-9_@]+$/", $_POST['data']['nick1'], $match) && $match[0] == $_POST['data']['nick1'])) {
        $_SESSION['msg'] .= "Nick should only contain alphabets and _ and @<br/>";
        $error = 1;
    }
    if ($_POST['data']['nick2'] != '' && !(preg_match("/^[a-zA-Z0-9_@]+$/", $_POST['data']['nick2'], $match) && $match[0] == $_POST['data']['nick2'])) {
        $_SESSION['msg'] .= "Nick sdfsf should only contain alphabets and _ and @<br/>";
        $error = 1;
    }
    ...
    if ($error == 1) {
        ...
        if ($res2) {
            ...
            $_SESSION['user']['lastmsgid'] = "0";
            $_SESSION['user']['msgid'] = "0";
            $_SESSION['user']['lastnotificationid'] = "0";
            $_SESSION['user']['notificationid'] = "0";
...
} else if (isset ($_SESSION['loggedin']) && isset ($_POST['approvefriend'])) {
    $_POST = secure($_POST);
...
} else if (isset ($_SESSION['loggedin']) && isset ($_POST['denyfriend'])) {
    $_POST = secure($_POST);
