...
<form id='form' method='post' action='<?php echo SITE_URL; ?>/process.php'>
    ...
    <div id="step1">
        ...
        <center><h3>Enter Data Manually</h3></center>
        <!-- Data Entry -->
        <div class="form-horizontal">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="fname" name="data[fullname]" <?php if (isset($_SESSION['data'])) echo "value='" . $_SESSION['data']['fullname'] . "'"; ?>>
                </div>
            </div>
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <input id="roll_number" name='data[roll_number]' type='text' style="width: 100px;" <?php if (isset($_SESSION['data'])) echo "value='" . $_SESSION['data']['roll_number'] . "'"; ?>>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="branch" name="data[branch]" <?php if (isset($_SESSION['data'])) echo "value='" . $_SESSION['data']['branch'] . "'"; ?>>
                </div>
            </div>
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <input type='text' name='data[room]' style="width:100px;" id="room" <?php if (isset($_SESSION['data'])) echo "value='" . $_SESSION['data']['room'] . "'"; ?>>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="email">Email</label>
                <div class="controls">
                    <input type="text" id="email" name="data[email]"<?php if (isset($_SESSION['data'])) echo "value='" . $_SESSION['data']['email'] . "'"; ?>>
                </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="secques" name="data[security_ques]" <?php if (isset($_SESSION['data'])) echo "value='" . $_SESSION['data']['security_ques'] . "'"; ?>>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="secans">Security Answer</label>
                <div class="controls">
                    <input type="password" id="secans" name="data[security_ans]" <?php if (isset($_SESSION['data'])) echo "value='" . $_SESSION['data']['security_ans'] . "'"; ?>>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="step2" style='display:none'>
        <div class="form-horizontal">
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="nick1" name="data[nick1]" <?php if (isset($_SESSION['data'])) echo "value='" . $_SESSION['data']['nick1'] . "'"; ?>>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="pass1">Password</label>
                <div class="controls">
                    <input type="password" id="pass1" name="data[password1]">
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="repass1">Retype Password</label>
                <div class="controls">
                    <input type="password" id="repass1" name="data[repassword1]">
                </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="password" id="pass2" name="data[password2]">
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="repass2">Password (optional)</label>
                <div class="controls">
                    <input type="password" id="repass2" name="data[repassword2]">
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="step3" style='display:none'>
        ...
        <div class="form-horizontal">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="friendnick" name="data[friend]" <?php if (isset($_SESSION['data'])) echo "value='" . $_SESSION['data']['friend'] . "'"; ?>>
                </div>
            </div>
        </div>
