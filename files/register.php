                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select id="roll_course" name='data[roll_course]' style="width: 90px;">
                            <option>BE</option><option>ME</option><option>MEEE</option><option>MESE</option><option>MESER</option><option>MCA</option><option>MBA</option><option>MBI</option><option>BPH</option><option>IPH</option><option>ICH</option><option>MPH</option><option>BT</option><option>MT/CS</option><option>MT/IS</option><option>MT/RS</option><option>MSC</option><option>BARCH</option><option>BHMCT</option><option>BMI</option><option>MUP</option><option>IMH</option><option>PHD</option><option>EMP</option>
                        </select>
